...
<body>
    <div class="app">
        <form class="form" method="POST" action="./control.php">
            ...
            <h1 class="form-title">Chào mừng bạn đến với Fullstack</h1>
            <div class="row">
            ...
            <button type="submit" class="form-btn" name="btn-login">Đăng nhập</button>
            <span class="form-control">Bạn chưa có tài khoản? <a href="./register.php">Đăng ký</a></span>
